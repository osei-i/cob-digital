    ...
    return ( <div>
        ...
        bg-clip-text 
            ...
            <p className="mt-4 text-lg font-normal text-slate-800 ,ax-w-lg text-center mx-auto px-4">
              Your audience is online. The question is — are you showing up the right way?
We create scroll-stopping content, build real engagement, and turn followers into paying clients. Stop guessing. Start growing.
            </p>
            </div>
