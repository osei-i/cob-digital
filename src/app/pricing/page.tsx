...
const plans = [
  {
    ...
    style:
      " rounded-3xl  py-10 bg-clip-text text-slate-800",
    description:
  ...
  },
  {
    ...
    style:
      " h-full rounded-3xl py-10 flex flex-col  bg-clip-text text-transparent bg-linear-to-b from-[#6B1F2B] to-[#8A3A46]  ",
    description:
...
<div className="flex items-center justify-center flex-col   ">
          <div className="text-5xl pb-10 md:pb-20  px-6 text-center bg-clip-text text-transparent bg-linear-to-b 
            from-[#6B1F2B]
                ...
                <div className={plan.style}>
                  <div className="text-4xl flex  items-center font-medium">
                    ...
                    {plan.feature === "Contact Us" && (
                      <div className="text-sm font-medium text-slate-300 bg-[#6B1F2B] px-2 py-1 rounded-full ml-4 items-center ">
                        Contact Us
                      </div>
                    )}
                  </div>
                  ...
                  <ul>
                    {plan.features.map((feature) => (
                      ...
                      >
                        ...
                        {plan.feature === "Contact Us" ? (
                          <PiCheckCircleFill className="text-slate-700 mr-2 text-xl" />
                        ) : (
                          <PiCheckCircleFill className="text-slate-700 mr-2 text-xl" />
                        )}
                ...
                <div className={plan.button}>
                  {index === 0 && (
                    <Link
                      ...
                      className="rounded-3xl my-4  py-2 text-slate-600 w-full mx-auto items-center flex justify-center  bg-linear-to-b 
            from-[#6B1F2B]
            to-[#8A3A46] bg-opacity-50"
                    >
                      Buy Now
